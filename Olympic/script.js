  ...
  document.getElementById("save").addEventListener("click", function() {
    var expensesInput = document.getElementById("exp");
    var expenses = parseFloat(expensesInput.value);
    var previousDeductionsInput = document.getElementById("prev-deductions");
  ...
  document.getElementById("lang-selector").addEventListener("click", function() {
    if (language === "ru") {
      language = "en";
      document.getElementById("lang-selector").textContent = "Русский";
      document.getElementById("res").innerHTML = "";
      document.getElementById("save").style.display = "none";
    } else {
      language = "ru";
      document.getElementById("lang-selector").textContent = "English";
      document.getElementById("res").innerHTML = "";
      document.getElementById("save").style.display = "none";
    }
  ...
  function updateInterfaceLanguage() {
    var expensesLabel = document.querySelector("label[for='exp']");
    var previousDeductionsLabel = document.querySelector("label[for='prev-deductions']");
    var maxDeduction = document.querySelector("label[for='max-deduction']");
    var calculateButton = document.getElementById("calc");
    var saveButton = document.getElementById("save");
    var languageSelectorButton = document.getElementById("lang-selector");
  ...
  document.getElementById("prev-deductions").addEventListener("input", function() {
    var previousDeductionsInput = document.getElementById("prev-deductions");
